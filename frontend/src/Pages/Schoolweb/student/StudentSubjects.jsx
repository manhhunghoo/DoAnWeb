...
import React, { useEffect, useState } from 'react';
import { BottomNavigation, BottomNavigationAction, Paper, Table, TableBody, TableHead, Typography } from '@mui/material';
import InsertChartIcon from '@mui/icons-material/InsertChart';
import InsertChartOutlinedIcon from '@mui/icons-material/InsertChartOutlined';
import TableChartIcon from '@mui/icons-material/TableChart';
import TableChartOutlinedIcon from '@mui/icons-material/TableChartOutlined';
...
const StudentSubjects = () => {
    ...
    useEffect(() => {
        ...
        const mockSubjectMarks = [
            { subName: 'Math', marksObtained: 80 },
            { subName: 'Science', marksObtained: 90 },
            { subName: 'English', marksObtained: 75 },
        ];
    ...
    const renderClassDetailsSection = () => {
        return (
            <div>
                ...
                <Typography variant="h5" gutterBottom>
                    You are currently in Class 10
                </Typography>
                <Typography variant="h6" gutterBottom>
                    And these are the subjects:
                </Typography>
                <div>
                    <Typography variant="subtitle1">Math (MTH)</Typography>
                </div>
                <div>
                    <Typography variant="subtitle1">Science (SCI)</Typography>
                </div>
                <div>
                    <Typography variant="subtitle1">English (ENG)</Typography>
                </div>
            </div>
        );
    };
